            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form name="memberRegisterFrm" method="post" class="space-y-4 md:space-y-6">
                    <div class="relative">
                        ...
                        <span class="guide ok text-blue-700 absolute hidden top-9 end-1">이 아이디는 사용 가능합니다.</span>
                        <span class="guide error text-red-700 absolute hidden top-9 end-1">이 아이디는 이미 사용 중입니다.</span>
