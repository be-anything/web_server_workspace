    ...
    <div class="w-full p-6 bg-white border border-gray-200 rounded-lg shadow">
        ...
        <c:if test="${(loginMember.id eq board.memberId) || (loginMember.role eq Role.A)}">
            <div class="flex justify-end">
                ...
                <button type="button"
                        class="del-btn px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-red-700 rounded-lg focus:ring-4 focus:ring-primary-200">
                    삭제
                </button>
            </div>
            <form name="boardDeleteFrm" action="${pageContext.request.contextPath}/board/boardDelete" method="post">
                    ...
                    <tr class="bg-white border-b hover:bg-gray-50">
                        <td scope="row" colspan="2" class="w-4/6 px-6 py-4 font-medium text-gray-800">
                            ...
                            <sub class="text-gray-400">
                                <fmt:parseDate value="${comment.regDate}" var="regDate" pattern="yyyy-MM-dd'T'HH:mm" />
                                <fmt:formatDate value="${regDate}" pattern="yy/MM/dd HH:mm" />
                            </sub>
                            <p class="mt-2">
                                ${comment.content}
