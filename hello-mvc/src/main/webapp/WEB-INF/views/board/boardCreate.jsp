        ...
        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" name="memberId" id="memberId"
                       ...
                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required readonly>
            </div>
            <div class="sm:col-span-2">
                <label for="upFile" class="block mb-2 text-sm font-medium text-gray-900">첨부파일</label>
            ...
            <div class="sm:col-span-2">
                ...
                <textarea name="content" id="content" required rows="8" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500" placeholder="내용을 작성하세요."></textarea>
            </div>
        </div>
