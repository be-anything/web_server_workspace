    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <form name="memberSearchFrm">
            <div class="p-4 bg-white flex">
                ...
                <div class="ml-1">
                    <input type="search" id="search-keyword" name="search-keyword" value="${param['search-keyword']}" required placeholder="검색어를 입력하세요..." class="block p-2 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500" >
                </div>
            </div>
        </form>
        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
            ...
            <c:forEach items="${members}" var="member" varStatus="vs">
                <tr class="bg-white border-b">
                    ...
                    <td class="px-6 py-4">
                        <%-- update member set role = 'A || U' where id = 'id' --%>
...
<form name="memberRoleUpdateFrm" action="${pageContext.request.contextPath}/admin/updateMemberRole" method="post">
